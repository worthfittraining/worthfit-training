                ...
                <div className="space-y-1 max-h-48 overflow-y-auto">
                  {searchResults.map((r, i) => (
                    <button key={i} onClick={() => addIngredient(r)}
                      ...
                      <div className="text-xs text-gray-400">{r.calories} cal · {r.protein_g}g P · per serving ({r.serving})</div>
                    </button>
                  ))}
                </div>
              )}
                  ...
                  <div key={ing.id} className="border border-gray-100 rounded-xl p-3">
                    <div className="flex items-start justify-between mb-2">
                      <div className="min-w-0 pr-2">
                        ...
                        <p className="text-xs text-gray-400">1 serving = {ing.food.serving}</p>
                      </div>
