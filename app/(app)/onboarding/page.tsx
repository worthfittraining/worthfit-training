      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-lg">
        ...
        <div className="text-center mb-6">
          <div className="inline-flex items-center gap-2 bg-green-50 rounded-full px-4 py-2">
            <span className="text-green-600 font-bold text-sm">🥗 Nutrition by Nali</span>
          </div>
        </div>
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <label className="flex items-start gap-2.5 cursor-pointer max-w-xs">
                ...
                <span className="text-xs text-gray-500 leading-relaxed">
                  ...
                  , including the medical disclaimer. I understand Nutrition by Nali is not a medical service.
                </span>
              </label>
