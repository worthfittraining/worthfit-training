...
const TOOLS: Anthropic.Tool[] = [
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        meal_slot: { type: 'string', enum: ['breakfast', 'lunch', 'dinner', 'snack', 'dessert'], description: 'Which meal this belongs to' },
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        meal_slot: { type: 'string', enum: ['breakfast', 'lunch', 'dinner', 'snack', 'dessert'], description: 'Which meal slot to remove from' },
      },
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        carbs_g:   { type: 'number' },
        fat_g:     { type: 'number' },
        from_slot: { type: 'string', enum: ['breakfast', 'lunch', 'dinner', 'snack', 'dessert'] },
        to_slot:   { type: 'string', enum: ['breakfast', 'lunch', 'dinner', 'snack', 'dessert'] },
      },
